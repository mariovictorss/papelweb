...
# $Name$
# $Author: luciana $
# $Date: 2015-02-20 09:26:55 -0200 (Fri, 20 Feb 2015) $
...
Pacote de atualizacao unificado: 2.05.3
...
#
 ...
 verificaGestoes(){
	 ...
	 verifica "1.94.1" "2.05.3" "1" "gestaoAdministrativa" "2053"
	 verifica "1.96.0" "2.05.3" "2" "gestaoFinanceira" "2053"
	 verifica "1.92.4" "2.05.3" "3" "gestaoPatrimonial" "2053"
	 verifica "1.92.6" "2.05.3" "6" "gestaoPrestacaoContas" "2053"
	 verifica "1.97.7" "2.05.3" "4" "gestaoRH" "2053"
	 verifica "1.98.0" "2.05.3" "5" "gestaoTributaria" "2053"
 ...
 atualizaGestoes(){
	 ...
	 atualiza "1.94.1" "2.05.3" "1" "gestaoAdministrativa" "2053"
	 atualiza "1.96.0" "2.05.3" "2" "gestaoFinanceira" "2053"
	 atualiza "1.92.4" "2.05.3" "3" "gestaoPatrimonial" "2053"
	 atualiza "1.92.6" "2.05.3" "6" "gestaoPrestacaoContas" "2053"
	 atualiza "1.97.7" "2.05.3" "4" "gestaoRH" "2053"
	 atualiza "1.98.0" "2.05.3" "5" "gestaoTributaria" "2053"
}
