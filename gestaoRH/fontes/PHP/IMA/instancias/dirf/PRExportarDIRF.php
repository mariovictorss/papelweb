...
function dirf2010($rsTipo1, $rsTipo2, $rsTipo3, $boRetificadora, $boPrestadoresServico = false)
{
    ...
    $linha = 'Dirf|2016|'.$rsTipo1->getCampo('ano_calendario').'|'.$boRetificadora.'|'.$rsTipo1->getCampo('numero_recibo').'|L35QJS2|'."\n";
    fputs($file, $linha);
    ...
    $linha = 'DECPJ|'.str_pad($rsTipo1->getCampo('cnpj_declarante'),14,0,STR_PAD_LEFT).'|'.$rsTipo1->getCampo('nome_empresarial').'|2|'.
            str_pad($rsTipo1->getCampo('cpf_responsavel_prefeitura'),11,0,STR_PAD_LEFT)."|N|N|N|N|".$hasPlano."|N|N|N||\n";
    fputs($file, $linha);
